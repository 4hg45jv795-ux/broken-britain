...
const GRAFFITI = {
  ...
  in_cottagers: [
    ...
    {img:'graffiti_fdc', fw:420, fh:285, at:1560, h:190, yOff:-225, range:0,
...
const WEAPONS={
  ...
  bigblaster:   {name:'Big Blaster',    auto:false, cooldown:75, type:'bullet', pellets:1, spread:0.00, speed:10, range:680, dmg:999, knock:30, sprite:'bigblaster', spriteH:58, shake:true, pierce:true },  // 3-shot magazine + 90s recharge (see BB in engine.js); kills what it HITS, no screen-wipe.
